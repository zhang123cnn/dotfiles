...
you should place your code here."
  ...
  (global-set-key (kbd "<f12>") 'projectile-find-other-file)
  (global-set-key (kbd "<f11>") 'projectile-find-other-file-other-window)
  (global-set-key (kbd "<f3>") 'spacemacs/helm-project-smart-do-search-region-or-symbol)
  (global-set-key (kbd "<f4>") 'helm-cscope-find-global-definition)
  (global-set-key (kbd "<f5>") 'cscope-index-files)
  (global-linum-mode)
  (defun my-c-setup ()
